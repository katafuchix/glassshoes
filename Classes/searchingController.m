...
- (void)setInfo:(id)oya near:(BOOL)bNear{
	...
	[self connectCheckTimeOut:nil];
		
	m_timeoutTime = [NSTimer scheduledTimerWithTimeInterval:15.0
									 target:self
...
- (void)connectCheckTimeOut:( NSTimer *)aTimer{
	...
	if ( canToken && ( !m_bNear || canLocation ) ) {
...
- (void)commTimeOut:( NSTimer *)aTimer{
	...
	glassShoes *gs = [glassShoes sharedInstance];
	if ( m_bNear && [gs checkLocation] == false ) {
